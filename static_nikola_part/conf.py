...
USE_BASE_TAG = False
# It appears the above being True creates real problems with the rendering.
...
LICENSE = """<a rel="license" href="https://creativecommons.org/licenses/by-nd-nc/1.0/">
<img alt="Creative Commons License BY-ND-NC"
style="border-width:0; margin-bottom:12px;"
src="https://i.creativecommons.org/l/by-nd-nc/1.0/88x31.png"></a>"""
...
# Use asciidoctor rather than asciidoc. The documentation for the asciidoc
# plugin says do this.
